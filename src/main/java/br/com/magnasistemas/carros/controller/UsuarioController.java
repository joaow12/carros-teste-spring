...
public class UsuarioController {
	...
	@PostMapping
	public ResponseEntity<UsuarioVO> cadastrar(@RequestBody UsuarioVO usuario) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<UsuarioVO> atualizar(@PathVariable Long id, @RequestBody UsuarioVO usuario){
